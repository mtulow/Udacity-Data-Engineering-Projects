...
Link: [Data_Modeling_with_Postgres](./Data_Modeling_with_Postgres/README.md)
...
Link : [Data_Modeling_with_Apache_Cassandra](./Data_Modeling_with_Apache_Cassandra/README.md)
...
Use Redshift IaC script - [Redshift_IaC_README](./Redshift_IaC_README.md)

Link  - [Data_Warehouse](./Data_Warehouse/README.md)
...
Link: [Data_Lake](./Data_Lake/README.md)
...
Link:  [Airflow_Data_Pipelines](./Airflow_Data_Pipelines/README.md)
...
Link: [API to Postgres](./Data_Api_to_Postgres/README.md)
